...
def home():
    ...
    <style>
        ...
        .card-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px; font-size: 11px; }
        ...
        /* Новая аккуратная строка доходности дня на главном экране */
        .day-profit-line { font-size: 12px; font-weight: 700; margin-bottom: 12px; padding-left: 2px; }
        ...
        .report-table { width: 100%; border-collapse: collapse; font-size: 11px; text-align: left; margin-bottom: 12px; }
        ...
        .report-table td { padding: 6px 2px; border-bottom: 1px solid #0d0d11; font-weight: 600; }
        ...
        /* Сетка личной карточки счета внутри доходов */
        .account-details-box { background: #09090b; border-radius: 12px; border: 1px solid #1c1c1f; padding: 12px; margin-bottom: 20px; }
        .roi-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 6px; font-size: 11px; margin-bottom: 10px; }
    ...
    for login, info in accounts_data.items():
        ...
        <div class="account-details-box">
            <div class="roi-grid">
                ...
                <div style="text-align:right; margin-top:4px;"><span class="roi-badge">ROI {calc_roi:.2f}%</span></div>
                <div>&nbsp;</div>
                <div style="text-align:right;"><span class="rom-badge">ROM {calc_rom:.2f}%</span></div>
            </div>
            <table class="report-table" style="margin-top:12px; border-top: 1px solid #1c1c1f; padding-top:8px;">
                <thead><tr style="color:#71717a; font-size:9px;"><th>период счета</th><th>текущий</th><th>прошлый</th></tr></thead>
                <tbody>
        ...
        <div class="account-card" style="border-left: 5px solid {status_color};">
            ...
            <div class="day-profit-line">
                <span style="color:#71717a; font-size:10px; text-transform:uppercase; font-weight:700;">За сегодня:</span>
                <span style="color:{p_today_color}; font-size:12px; margin-left:3px;">{p_today_text} USD</span>
            </div>
            
            <div class="grid-main"><div style="font-size:11px; color:#71717a;">ID: {login}</div></div>
